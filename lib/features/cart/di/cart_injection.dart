...
Future<void> initCartDependencies(GetIt sl) async {
  ...
  sl.registerLazySingleton(() => GetCartItemById(sl()));

  sl.registerLazySingleton<CartRepository>(() => CartRepositoryImpl(localDataSource: sl()));
  sl.registerLazySingleton<CartLocalDataSource>(() => CartLocalDataSourceImpl(sharedPreferences: sl<SharedPreferences>()));
}
